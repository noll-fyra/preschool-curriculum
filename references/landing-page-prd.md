...
This document specifies the landing page for Nurture — a pre-launch educational page designed to build awareness and buy-in among three audiences: teachers, parents of enrolled children, and education providers or decision-makers considering building or adopting the platform.
...
### Audience 3: Education providers / decision-makers
...
- The problem being solved is real and widespread

---

## Page Structure

The page follows a problem → solution → proof → how it works → audience-specific reassurance → CTA structure. All sections below are in order.

---

### Section 1: Hero

**Purpose:** Establish what this is and why it matters in under 5 seconds.
...
**No CTA in the hero.** This page is educational. A CTA button here implies something to sign up for, which creates the wrong expectation. Instead, a subtle "↓ Learn how it works" link nudges visitors downward.

---

### Section 2: The Problem — named plainly
...
### Section 3: The Solution — what Nurture does
...
### Section 4: How the Milestones Work
...
Schools can also adapt the milestone schema to reflect their own curriculum emphasis, ensuring the system fits the school, not the other way around.

**Visual:** A clean, illustrated milestone progress card for a sample child — showing the three areas, the three levels, and which milestones are achieved/in progress/not started. This is the most powerful thing to show non-technical stakeholders: the actual artefact they will use.

---

### Section 5: What Teachers Actually Experience
...
> **Monday morning.** You open your dashboard. Each child's status card shows exactly where they are — no digging through notes from last week.

> **During the day.** You notice Kai waiting patiently for his turn during circle time — something he struggled with last month. You tap his name, tap the milestone, and log it. Five seconds.
...
### Section 6: What Parents Actually See
...
### Section 8: Grounded in Research
...
- **45%** of early childhood educators report high burnout — administrative load is a leading cause.
- **60%+** of parents want to engage their child in learning at home, but most don't know what to do.
- Children who receive consistent parent-teacher collaboration show stronger outcomes across literacy, numeracy, and social development.

**Body copy (short):**
Nurture was built in direct response to these realities — starting with conversations with school directors, teachers, and parents, not with technology looking for a problem. The milestone framework, the activity design, and the parent experience were all shaped by how preschool education actually works in Singapore.

---

### Section 9: For Education Providers
...
**Short paragraph:**
Nurture was designed with adaptability in mind. The milestone schema is grounded in the NEL Framework but can be extended or modified to reflect any school's curriculum emphasis, pedagogical approach, or learning area priorities. If you're a preschool director, curriculum specialist, or early childhood operator exploring what a structured learning platform could look like for your context, we'd like to talk.

**CTA:** A simple link or email address — "Get in touch" — that opens an email. No form. Low friction.
...
These links can point to simple one-page FAQs, or can be placeholders for launch.

---

## Design Direction

**Visual tone:** Warm, calm, professional. Not cartoonish (this is used by educators) but not clinical (this is used by children and parents). A palette built around soft greens and warm neutrals, with clear typographic hierarchy.

**Photography vs. illustration:** Prefer illustration over photography for the product itself — it avoids showing real children and allows the content to feel universal regardless of demographic. Photography (of real classroom moments, not stock) can be used sparingly in the teacher/parent sections if available.

**Accessibility:** All informational content must be accessible at AA standard. Images must have alt text. Colour contrast must meet minimum ratios. The page must be readable on mobile — the parent audience will primarily visit on their phone.

**Animation:** Minimal. The product itself has engaging animation; the landing page should feel calm and trustworthy by contrast. Subtle entrance animations on scroll are acceptable. No autoplay video or distracting motion.

---

## Copy Principles

**Write to be understood, not to impress.** The audience includes teachers with early childhood education qualifications and parents who just want to know what their kid is doing at school. Jargon-free wherever possible — and where pedagogical terms are used (phonemic awareness, one-to-one correspondence), they must be immediately explained in plain language.

**Lead with outcomes, not features.** "Know what your child is learning every day" before "real-time progress feed." "Spend 15 minutes on reports instead of two hours" before "auto-generated assessment drafts."

**Acknowledge the concerns.** Teachers worry about surveillance. Parents worry about screen time. The page should name these concerns and address them directly — not pretend they don't exist.

**Tone:** Warm, confident, honest. The tone of a school that knows what it's doing and genuinely cares about its children. Never corporate. Never over-promising.

---

## Success Criteria

Since this is an educational page with no sign-up mechanic, success is measured qualitatively:

- Teachers who read the page should feel reassured, not threatened
- Parents who read the page should feel excited, not anxious about screen time
- Education providers who read the page should feel the system is credible enough to have a follow-up conversation about
