...
*Version 1.0 | Status: In Progress | Owner: Director, NTUC First Campus*
...
| Milestone framework alignment | NEL Framework 2022. My First Skool's PETAL approach is pedagogically compatible; no separate milestone schema required. |
