  ...
  return (
    ...
    >
      <div className="p-4 text-center">
        ...
        <p className="text-xs font-semibold mb-3" style={{ color: "#333333" }}>
  ...
  return (
    ...
    >
      <div className="p-4 text-center">
        ...
        <div className="flex justify-center gap-2 mb-3 flex-wrap">
          {["🌟", "🎉", "🏆", "⭐", "🌈", "🎨"].map((s, i) => (
            <div
              ...
              style={{
                backgroundColor: i < 4 ? "#FFF8E8" : "#F5F5F5",
        ...
        <p className="text-xs" style={{ color: "#999999", fontSize: 10 }}>
          4 of 6 earned this week
        </p>
      </div>
    </div>
  );
      ...
      <div className="max-w-5xl mx-auto px-5">
        ...
        <div className="flex flex-col gap-4">
          ...
          <AnimateIn delay={0.05}>
            <Link
              href="/children"
              aria-label="See the activity queue"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
                <div className="p-8 flex flex-col gap-4">
                  ...
                  <p
                    ...
                    style={{ color: "#666666" }}
                  >
                    Each child gets a short queue of tap-to-answer activities
                    matched to their current milestone level. No reading
                    required.
                  </p>
                </div>
                <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-stretch">
            <AnimateIn delay={0.08} className="h-full">
              <Link
                href="/children"
                aria-label="Learn about audio guidance"
