              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
                <div className="p-8 flex flex-col gap-4">
                  <div className="grid grid-cols-[minmax(0,1fr)_auto] gap-x-4 gap-y-2 items-start">
                    <p className="text-sm font-semibold mb-2 col-span-2" style={{ color: "#999999" }}>Activity queue</p>
              ...
              >
                <div className="h-full flex flex-col">
                  <div className="p-6 flex flex-col gap-3">
                    <div className="grid grid-cols-[minmax(0,1fr)_auto] gap-x-4 gap-y-2 items-start">
                      <p className="text-sm font-semibold col-span-2" style={{ color: "#999999" }}>Audio guidance</p>
            ...
            <AnimateIn delay={0.12} className="h-full">
              ...
              >
                <div className="h-full flex flex-col">
                  <div className="p-6 flex flex-col gap-3">
                    <div className="grid grid-cols-[minmax(0,1fr)_auto] gap-x-4 gap-y-2 items-start">
                      <p className="text-sm font-semibold col-span-2" style={{ color: "#999999" }}>Rewards</p>
                      <p className="font-extrabold leading-tight" style={{ fontSize: "clamp(1.1rem, 2vw, 1.4rem)", color: "#333333", letterSpacing: "-0.02em" }}>
