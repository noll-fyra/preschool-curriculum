...
const features = [
  {
    ...
    subtitle:
      "Each child gets activities matched to exactly where they are, providing the right balance of challenge and consistent progress.",
    color: "#F79863",
    accentBg: "#FEF0E7",
  },
  {
    ...
    subtitle:
      "Progress and performance is captured automatically as children play, so teachers never need to enter data manually.",
    color: "#F5A623",
    accentBg: "#FFFBF2",
  },
  {
    id: "reports",
    title: "Smart documentation creation",
    subtitle:
      "Logging, reports, workplans and more are generated in just a few taps.",
    color: "#7BA3D4",
    accentBg: "#F2F7FD",
  },
  {
    ...
    subtitle:
      "Updates, messaging and announcements are integrated so teachers and parents share a connected view.",
    color: "#E8745A",
    accentBg: "#FDF3F1",
  },
  {
    ...
    subtitle:
      "Parents see what their child is working on in plain language, updated in real time.",
    color: "#F79863",
    accentBg: "#FEF0E7",
  },
];
    ...
    >
      ...
      <div className="flex-1 p-6 flex flex-col gap-3">
        <div className="flex items-center justify-between mb-1">
          <div
            className="h-4 rounded-full w-40"
            style={{ backgroundColor: `${feature.color}25` }}
          />
          <div
            className="h-7 rounded-lg w-20"
          ...
          >
            ...
            <div className="flex-1 space-y-1.5">
              ...
              <div
                ...
                style={{ width: `${w * 0.55}%`, backgroundColor: "#EBEBEB" }}
              />
            </div>
            <div
    ...
    >
      <div className="max-w-5xl mx-auto px-5">
        ...
        <AnimateIn>
          ...
          >
            A learning platform for modern preschools.
          </h2>
        </AnimateIn>
                ...
                {features.map((_, i) => (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 4,
                      backgroundColor:
                        i === activeIndex ? active.color : "#D0D0D0",
                      border: "none",
                      padding: 0,
                      cursor: "pointer",
                    }}
        ...
        <AnimateIn delay={0.1}>
          <p
            className="text-sm font-semibold mt-10 mb-3"
            style={{ color: "#737373" }}
          >
            ...
            {[
              {
                ...
                icon: (
                  ...
                  >
                    ...
                    <path
                      d="M14 16h16M14 21h11M22 30l5-3h3a1.5 1.5 0 001.5-1.5V16A1.5 1.5 0 0030 14.5H14A1.5 1.5 0 0012.5 16v9.5A1.5 1.5 0 0014 27h2"
                      stroke="#F79863"
                      strokeWidth="1.75"
                      strokeLinecap="round"
              ...
              },
              {
                ...
                icon: (
                  ...
                  >
                    ...
                    <path
                      d="M22 13l2.5 6H30l-4.5 3.5 1.5 6L22 25l-5 3.5 1.5-6L14 19h5.5L22 13z"
                      stroke="#F5A623"
                      strokeWidth="1.75"
                      strokeLinejoin="round"
                    />
              ...
              },
              {
                ...
                icon: (
                  ...
                  >
                    ...
                    <path
                      d="M22 21a4 4 0 100-8 4 4 0 000 8zM13 33c0-4.418 4.03-8 9-8s9 3.582 9 8"
                      stroke="#E8745A"
                      strokeWidth="1.75"
                      strokeLinecap="round"
                    />
              ...
              },
              {
                ...
                icon: (
                  ...
                  >
                    ...
                    <path
                      d="M13 32V21l9-7 9 7v11M18 32v-6h8v6"
                      stroke="#7BA3D4"
                      strokeWidth="1.75"
                      strokeLinecap="round"
                      strokeLinejoin="round"
