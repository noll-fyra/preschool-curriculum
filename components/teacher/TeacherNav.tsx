...
export function TeacherNav() {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden min-h-0 w-[220px] shrink-0 flex-col self-stretch overflow-hidden border-r bg-card md:flex">
        {/* Logo + class switcher */}
        ...
        <div className="shrink-0 flex flex-col gap-1 border-t px-3 py-3">
