  ...
  return (
    <div className="px-4 py-5 max-w-lg mx-auto">
      ...
      <div
        ...
        style={{ background: "var(--color-primary-wash)", borderColor: "var(--color-primary)" }}
      >
        <p style={{ fontSize: 13, color: "var(--color-text-dark)" }}>
          <span className="font-semibold">{achievedCount}</span> of {totalMilestones} milestones achieved
        </p>
        <Link
      ...
      >
        <p className="font-semibold mb-0.5" style={{ color: "var(--color-text-dark)" }}>
          Progress over time
        </p>
