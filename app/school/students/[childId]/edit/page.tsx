  ...
  if (!child) {
    return (
      <div className="px-5 py-8">
        ...
        <Link href="/school/students" className="text-sm font-medium mt-2 inline-block" style={{ color: "var(--color-primary)" }}>
          ← Back to students
        </Link>
      </div>
    );
    ...
    <div className="px-5 py-6 md:px-8 md:py-8 max-w-lg">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <Link href="/school/students" className="px-4 py-2.5 rounded-lg text-sm font-medium border" style={{ borderColor: "var(--color-border)", color: "var(--color-text-mid)" }}>
            Cancel
          </Link>
        </div>
      </form>
